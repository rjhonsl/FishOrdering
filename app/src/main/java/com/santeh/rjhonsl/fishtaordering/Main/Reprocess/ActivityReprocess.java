 ...
 */
public class ActivityReprocess extends AppCompatActivity {

    Activity activity;
    Context context;
    private static RecyclerView rvdrConf;
    public AdapterReprocessDetails blboAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activity = this;
        context = ActivityReprocess.this;
...
//                        itemlist_OUT = new ArrayList<>();
                        Intent intent = new Intent(activity, Activity_Create_Reprocess.class);
    ...
    private void populatelist() {
        ...
        blboList = db.getAllReprocess();
        if (blboList.size() >0){
            blboAdapter = new AdapterReprocessDetails(blboList, context, activity);
